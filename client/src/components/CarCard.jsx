    ...
    transition-all duration-500 cursor-pointer'>
        <div className='relative h-48 overflow-hidden'>
            <img src={car.image} alt= "Car Image" className='w-full h-full object-cover transition-transform duration-500
             ...
             {car.isAvaliable && <p className='absolute top-4 left-4 bg-primary/90 text-white text-xs px-2.5 py-1 
             rounded-full'> Available Now </p>}
             <span className='absolute bottom-3 left-4 font-semibold text-white drop-shadow-md'>{currency}{car.pricePerDay} <span className='text-sm text-white/80'>/ day</span></span>
        </div>
